...
| `act` | 8 | Acts — name, number, function, dramatic question, shift |
| `sequence` | 11 | Scene groups — act link, goal, conflict, outcome, turning point |
| `scene` | 21 | Scenes — heading, location link, emotional beat, visual/sound notes |
| `story_beat` | 9 | Sub-scene narrative units — type, description, value shift, POV |
...
| Metric | Count |
|---|---|
| Total entity types | 98 |
| Total fields across all entities | 864 |
| Categories | 10 |
...
| Reference (foreign key) fields | ~78 |
...
| Category | Entities |
|---|---|
| Structure | `project`, `act`, `scene`, `sequence`, `story_beat`, `shot` |
